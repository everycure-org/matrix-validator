...
class TestUtilFunctions(unittest.TestCase):
    ...
    def test_analyze_edge_types(self):
        ...
        edges_data = {
            ...
            "predicate": ["biolink:related_to", "biolink:affects", "biolink:interacts_with", 
                         "biolink:treats", "biolink:related_to", "biolink:related_to"],
        ...
        with mock.patch('matrix_validator.util.get_valid_edge_types') as mock_get_valid_edge_types:
            ...
            unknown_edges = [row for row in result.to_dicts() 
